...
public class Data {
    ...
    public static String USER_IDENTITY_EXAM_MANAGER = "teacher";
    public static String USER_IDENTITY_SYSTEM_MANAGER = "manager";
    ...
    public static String[] USER_IDENTITIES = {USER_IDENTITY_STUDENT,USER_IDENTITY_EXAM_MANAGER,USER_IDENTITY_SYSTEM_MANAGER};
    public static String[] USER_IDENTITIES_CN = {USER_IDENTITY_STUDENT_CN,USER_IDENTITY_EXAM_MANAGER_CN,USER_IDENTITY_SYSTEM_MANAGER_CN};
